...
const I18N = {
  tr: {
    ...
    "intro.p1": "Her tedavi, ayrıntılı bir muayene ve kapsamlı değerlendirme ile başlar. Dijital planlama, büyütme altında hassas çalışma ve diş laboratuvarıyla yakın iş birliği, tedavi sürecimizin temel unsurlarını oluşturur.",
    "intro.p2": "Estetik beklentilerin yanı sıra çiğneme fonksiyonu, çene ekleminin sağlığı ve uzun dönemli ağız sağlığı da bütüncül bir yaklaşımla değerlendirilir.",
    "intro.cta": "Randevu Al",

    "treat.kicker": "Tedaviler",
    "treat.h2": "Başlıca <em>tedavi alanları.</em>",
    "treat.aside": "Her hastanın ihtiyacına uygun, bilimsel ve güncel yaklaşımlarla planlanan tedavi seçenekleri sunulmaktadır.",
    "t1.title": "Gülüş Tasarımı",
    "t1.desc": "Dişlerin şekli, boyutu ve dizilimi kişiye özel olarak dijital ortamda planlanır. Tedavi süreci, istekleriniz ve mevcut ağız durumu dikkate alınarak birlikte yürütülür.",
    "timp.title": "Dental İmplant",
    "timp.desc": "Eksik dişlerin tedavisinde implant uygulamaları, ayrıntılı muayene ve dijital planlama ile gerçekleştirilir. Tedavi süreci, klinik değerlendirme sonuçlarına göre kişiye özel olarak planlanır.",
    "t2.title": "Çene Eklem Bozuklukları",
    "t2.desc": "Çene ekleminde ağrı, ses, kilitlenme ve diş sıkma gibi şikayetler ayrıntılı olarak değerlendirilir. Tedavi, hastalığın türüne ve şikayetlerin şiddetine göre planlanır. Uygun vakalarda eklem splintleri (gece plağı) ve koruyucu yaklaşımlar tercih edilir.",
    "t3.title": "Horlama Protezi",
    "t3.desc": "Horlama ve bazı hafif uyku apnesi vakalarında, uyku sırasında kullanılan kişiye özel ağız içi apareyler hazırlanır. Bu apareyler alt çenenin pozisyonunu düzenleyerek hava yolunun açık kalmasına yardımcı olur. Tedaviye uygunluk, muayene ve gerekli değerlendirmeler sonrasında belirlenir.",
    "treat.more": "Randevu al",

    "about.kicker": "Hakkında",
    "about.h2": "Kubilay Barış <em>Çiçek</em>",
    "about.p1": "Kubilay Barış Çiçek lisans eğitimini 2017 yılında Erciyes Üniversitesi Diş Hekimliği Fakültesinde tamamladı. 2018 yılında Diş Hekimliğinde Uzmanlık Sınavını kazanarak Cumhuriyet Üniversitesi Diş Hekimliği Fakültesi’nde uzmanlık eğitimine başladı. “Temporomandibular eklem bölgesinde ağrı şikayeti olan hastaların non-invaziv ve minimal invaziv tedavi yöntemleri açısından retrospektif olarak değerlendirilmesi” konulu tez sunumuyla Protetik Diş Tedavisi Uzmanı unvanını aldı. 2024 yılından itibaren Bezmialem Vakıf Üniversitesi Diş Hekimliği Fakültesi Protetik Diş Tedavisi Anabilim Dalı’nda akademik ve klinik çalışmalarını sürdürmektedir.",
    "about.p2": "Dr. Çiçek; Türk Diş Hekimleri Birliği (TDB), International Team for Implantology (ITI) ve European Association for Osseointegration (EAO) derneklerinin aktif üyesi olup Bursa ITI Study Club co-direktörü olarak görev yapmaktadır.",
    "about.cta": "Randevu Al",
    "about.ig": "@dr_kubikbc",

    "journey.kicker": "Tedavi Süreci",
    "journey.h2": "Tüm tedavi aşamaları, klinik bulgular doğrultusunda ve <em>detaylı</em> bir şekilde planlanır.",
    "j1.t": "Muayene ve Değerlendirme", "j1.d": "Kapsamlı anamnez alınarak; estetik, dental, periodontal yapılar ve çene eklemini (stomatognatik sistem) içine alan detaylı klinik muayene gerçekleştirilir.",
    "j2.t": "Görüntüleme ve Kayıt", "j2.d": "Gerekli radyografik incelemeler ve dijital ölçüler alınarak mevcut klinik durum kayıt altına alınır.",
    "j3.t": "Tedavi Planlaması", "j3.d": "Tedavi seçenekleri ve süreç sizinle birlikte değerlendirilip karara bağlanır.",
    "j4.t": "Dijital Planlama", "j4.d": "Yapılacak işlemler dijital ortamda tasarlanır ve tedavi hedefleri netleştirilir.",
    "j5.t": "Uygulama", "j5.d": "Belirlenen tedavi planı, güncel klinik protokollere uygun olarak gerçekleştirilir.",
    "j6.t": "Kontrol ve Uyum", "j6.d": "Uygulanan tedavinin estetik, biyomekanik, okluzyon ve çevre dokularla fonksiyonel ilişkileri değerlendirilir.",
    "j7.t": "Takip", "j7.d": "Düzenli kontroller ve bakım önerileriyle tedavinin uzun dönem takibi yapılır.",
    "journey.foot": "Her aşamada bilgilendirme yapılır.",

    "edu.kicker": "Klinik ve Bilimsel Eğitimler",
    "edu.h2": "Meslektaşlara yönelik <em>eğitimler.</em>",
    "edu.p": "<strong>Teorik ve Uygulamalı Oturumlar:</strong> Estetik ve dijital diş hekimliğindeki güncel yaklaşımların ele alındığı, kanıta dayalı ve interaktif (hands-on) klinik eğitimler.",
    "edu.p2": "<strong>İletişim ve Planlama:</strong> Eğitim talepleri, çalışma grupları ve takvim detayları için iletişime geçebilirsiniz.",
  ...
  en: {
    ...
    "intro.p1": "Every treatment begins with a detailed examination and a thorough assessment. Digital planning, precise work under magnification and close collaboration with the dental laboratory form the core elements of our treatment process.",
    "intro.p2": "Beyond aesthetic expectations, chewing function, the health of the jaw joint and long-term oral health are all evaluated with a holistic approach.",
    "intro.cta": "Book Appointment",

    "treat.kicker": "Treatments",
    "treat.h2": "Main <em>areas of treatment.</em>",
    "treat.aside": "Treatment options are offered, planned with scientific and up-to-date approaches suited to each patient's needs.",
    "t1.title": "Smile Design",
    "t1.desc": "The shape, size and alignment of the teeth are planned digitally and individually for each person. The treatment process is carried out together, taking your wishes and your current oral condition into account.",
    "timp.title": "Dental Implant",
    "timp.desc": "In the treatment of missing teeth, implant applications are carried out with a detailed examination and digital planning. The treatment process is planned individually according to the results of the clinical assessment.",
    "t2.title": "Temporomandibular Disorders",
    "t2.desc": "Complaints such as pain, clicking, locking and clenching in the jaw joint are assessed in detail. Treatment is planned according to the type of disorder and the severity of the complaints. In suitable cases, joint splints (night guards) and protective approaches are preferred.",
    "t3.title": "Snoring Appliance",
    "t3.desc": "For snoring and some mild sleep apnoea cases, custom intraoral appliances worn during sleep are prepared. By adjusting the position of the lower jaw, these appliances help keep the airway open. Suitability for treatment is determined after examination and the necessary assessments.",
    "treat.more": "Book",

    "about.kicker": "About",
    "about.h2": "Kubilay Barış <em>Çiçek</em>",
    "about.p1": "Kubilay Barış Çiçek completed his undergraduate education at Erciyes University Faculty of Dentistry in 2017. In 2018 he passed the Dental Specialisation Examination and began his specialty training at Cumhuriyet University Faculty of Dentistry. He earned the title of Specialist in Prosthetic Dentistry with a thesis titled “A retrospective evaluation of patients with temporomandibular joint pain in terms of non-invasive and minimally invasive treatment methods.” Since 2024 he has continued his academic and clinical work in the Department of Prosthetic Dentistry at Bezmialem Vakıf University Faculty of Dentistry.",
    "about.p2": "Dr. Çiçek is an active member of the Turkish Dental Association (TDB), the International Team for Implantology (ITI) and the European Association for Osseointegration (EAO), and serves as co-director of the Bursa ITI Study Club.",
    "about.cta": "Book Appointment",
    "about.ig": "@dr_kubikbc",

    "journey.kicker": "Treatment Process",
    "journey.h2": "Every stage of treatment is planned in <em>detail</em>, in line with the clinical findings.",
    "j1.t": "Examination & Assessment", "j1.d": "A comprehensive history is taken and a detailed clinical examination is carried out, covering the aesthetic, dental and periodontal structures and the jaw joint (the stomatognathic system).",
    "j2.t": "Imaging & Records", "j2.d": "The necessary radiographic examinations and digital impressions are taken to document the current clinical situation.",
    "j3.t": "Treatment Planning", "j3.d": "Treatment options and the process are evaluated and decided on together with you.",
    "j4.t": "Digital Planning", "j4.d": "The procedures to be carried out are designed in a digital environment and the treatment goals are clarified.",
    "j5.t": "Application", "j5.d": "The agreed treatment plan is carried out in accordance with current clinical protocols.",
    "j6.t": "Check & Fit", "j6.d": "The aesthetic, biomechanical and occlusal relationships of the treatment, and its function with the surrounding tissues, are evaluated.",
    "j7.t": "Follow-up", "j7.d": "The treatment is followed up over the long term with regular check-ups and care recommendations.",
    "journey.foot": "You are informed at every stage.",

    "edu.kicker": "Clinical & Scientific Training",
    "edu.h2": "Training for <em>fellow dentists.</em>",
    "edu.p": "<strong>Theoretical & Hands-on Sessions:</strong> Evidence-based, interactive (hands-on) clinical training covering current approaches in aesthetic and digital dentistry.",
    "edu.p2": "<strong>Contact & Planning:</strong> Get in touch for training requests, study groups and calendar details.",
